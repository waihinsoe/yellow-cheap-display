...
void setup() {
  ...
  lv_obj_add_event_cb(objects.keyboard_toogle_btn,keyboard_toogle_btn_event_handler, LV_EVENT_CLICKED,NULL );
  lv_obj_add_event_cb(objects.obj0,keyboard_key_handler, LV_EVENT_VALUE_CHANGED,NULL );
...
static void keyboard_toogle_btn_event_handler(lv_event_t *e) {
  lv_event_code_t code = lv_event_get_code(e);

  if(keyboardStatus == 1) {
    lv_obj_add_flag(objects.keyboard_container, LV_OBJ_FLAG_HIDDEN);
    keyboardStatus = 0;
  }else{
    lv_obj_remove_flag(objects.keyboard_container, LV_OBJ_FLAG_HIDDEN);
    keyboardStatus = 1;
  }
}

static void keyboard_key_handler(lv_event_t *e) {
